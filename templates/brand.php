...
<head>
    ...
    <link rel="stylesheet" href="/perfume-catalog/assets/css/brand.css">
...
<header class="header">
    <div class="container header__container">
        <!-- Логотип -->
        <a href="/perfume-catalog/catalog" class="logo">
        ...
        <div class="header__user">
            <a href="/perfume-catalog/login" class="user-btn" aria-label="Личный кабинет">
...
<nav class="breadcrumbs container" aria-label="Хлебные крошки">
    <ol class="breadcrumbs__list">
        <li class="breadcrumbs__item">
            <a href="/perfume-catalog/catalog" class="breadcrumbs__link">Каталог</a>
        </li>
        <li class="breadcrumbs__item">
...
<div class="back-to-catalog">
    <div class="container">
        <a href="/perfume-catalog/" class="btn-back">
...
<script src="/perfume-catalog/assets/js/brand.js"></script>
</body>
</html>